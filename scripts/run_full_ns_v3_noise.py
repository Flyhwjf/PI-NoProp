...
def main():
    ...
    result = {'schema_version': 1, 'protocol': {
        ...
        'clean_trained': True, 'trajectory_disjoint_test': True}, 'results': {}}
        ...
        for method in METHODS:
            ...
            for seed in SEEDS:
                ...
                run = (ROOT/'outputs/runs'/
                       f'full_ns_v3_{method}_{region}_lambda{weight}_seed{seed}')
                ...
                stats = np.load(ROOT/'data/cache_hit_ns_v2/stats.npz')
    ...
    output = ROOT/'outputs/aggregate/full_ns_v3_noise.json'
