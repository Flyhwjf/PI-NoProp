"""Run full Navier--Stokes discovery on the decaying-HIT v2 dataset."""
...
from src.spider_ns_v2 import NSSPIDERConfig, discover


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset', default='data/generated_hit_ns_v2')
    parser.add_argument('--output', default='outputs/spider/hit_full_ns_v2.json')
