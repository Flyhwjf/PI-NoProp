"""Audit whether the v2 future-decay target is identifiable from its input."""
...
from src.data.hit_ns_v2 import REGION_NAMES, build_learning_cache


def main():
    cache = ROOT/'data/cache_hit_ns_v2'
    build_learning_cache(ROOT/'data/generated_hit_ns_v2', cache)
    ...
    discovered = json.loads(
        (ROOT/'outputs/spider/hit_full_ns_v2.json').read_text(encoding='utf-8'))
    ...
    output = ROOT/'outputs/aggregate/hit_ns_v2_predictability_audit.json'
