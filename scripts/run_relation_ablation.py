...
def run_id(variant, seed):
    ...
    return (f'full_ns_v4_discovered_low_enstrophy_lambda0p01_seed{seed}'
...
def main():
    ...
    artifact = {'schema_version': 2, 'protocol': {
    ...
    output = ROOT/'outputs/aggregate/full_ns_relation_ablation.json'
