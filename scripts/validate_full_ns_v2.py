...
def main():
    dataset = Path('data/generated_hit_ns_v2')
    ...
    artifact = json.loads(Path('outputs/spider/hit_full_ns_v2.json')
    ...
    cache = Path('data/cache_hit_ns_v2')
    ...
    audit_path = Path('outputs/aggregate/hit_ns_v2_predictability_audit.json')
    ...
    aggregate = json.loads(Path('outputs/aggregate/full_ns_v3_results.json')
                           .read_text(encoding='utf-8'))
