...
It uses a correctly normalized 3/2 de-aliasing transform, a divergence-free RK4
...
class DecayingHITDNS:
    ...
    Omitting these factors produces an incorrect effective pressure
    coefficient near 0.293.
    """
