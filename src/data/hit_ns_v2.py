"""Trajectory-disjoint learning cache for the decaying-HIT NS-v2 dataset."""
...
def build_learning_cache(dataset_dir='data/generated_hit_ns_v2',
                         cache_dir='data/cache_hit_ns_v2',
...
class HITNSSequenceDataset(Dataset):
    def __init__(self, cache_dir, region, split, in_memory=True):
        ...
        if in_memory:
            ...
            raise NotImplementedError('v2 currently uses a bounded in-memory cache')
...
def create_hit_ns_v2_dataloaders(config):
